    ...
    (function (n) {
        ...
        (function (n) {
            ...
            a.a = function () {
                ...
                var l = {propertychange: !0}, p = w && function () {
                ...
                return {
                    ...
                    D: function (a, b, c) {
                    ...
                    }, Ba: g, extend: c, setPrototypeOf: d, Ab: g ? d : c, P: b, Ga: function (a, b, c) {
                        if (!a) return a;
                        var d = {}, e;
                        ...
                        return h ? Symbol(a) : a
                    }, Zd: 6 === p, $d: 7 === p, W: p, Lc: function (b, c) {
            ...
            (function () {
                ...
                a.a.ua = function (c, d) {
                    ...
                    if (v) if (v.parseHTML) e = v.parseHTML(c, d) || []; else {
                        ...
                        (e = d) || (e = w);
                        var l = e.parentWindow || e.defaultView || A, p = a.a.Db(c).toLowerCase(),
                            q = e.createElement("div"), t;
            ...
            var C = {
                equalityComparer: K, qa: function () {
                    return this[r].V
                }, Va: function () {
                    var b = [];
                    ...
                    var c = this[r], d = !1, e = c.wb ? n : !c.V, d = {qd: this, mb: c.I, Qb: c.V};
                    a.u.xc({
                        pd: d,
                        od: ba, o: this, Ya: e
                    });
            ...
            a.Wd = function (b, c, d) {
                function e(c) {
                    var e = a.xb(b, d).extend({ma: "always"}), h = e.subscribe(function (a) {
                        a && (h.s(), c(a))
                    });
            ...
            a.m = function () {
                function b(b) {
                    ...
                    if (1 < d.length) {
                        for (var x = 0, B; B = d[x]; ++x) {
                            ...
                            if (44 === u) {
                                if (0 >= h) {
                                    c.push(p && q.length ? {key: p, value: q.join("")} : {unknown: p || q.join("")});
                                    p = h = 0;
                                    q = [];
                                    continue
                                }
                            ...
                            } else if (47 === u && 1 < B.length && (47 === B.charCodeAt(1) || 42 === B.charCodeAt(1))) continue; else 47 === u && x && 1 < B.length ? (u = d[x - 1].match(f)) && !g[u[0]] && (b = b.substr(b.indexOf(B) + 1), d = b.match(e), x = -1, B = "/") : 40 === u || 123 === u || 91 === u ? ++h :
                ...
                var c = ["true", "false", "null", "undefined"],
                    d = /^(?:[$_a-z][$\w]*|(.+)(\.\s*[$_a-z][$\w]*|\[.+\]))$/i,
                    e = RegExp("\"(?:\\\\.|[^\"])*\"|'(?:\\\\.|[^'])*'|`(?:\\\\.|[^`])*`|/\\*(?:[^*]|\\*+[^*/])*\\*+/|//.*\n|/(?:\\\\.|[^/])+/w*|[^\\s:,/][^,\"'`{}()/:[\\]]*[^\\s,\"'`{}()/:[\\]]|[^\\s]", "g"),
                    f = /[\])"'A-Za-z0-9_$]+$/, g = {"in": 1, "return": 1, "typeof": 1},
                    h = {};
                return {
                    Ra: [], wa: h, ac: b, vb: function (e, f) {
                        ...
                        f = f || {};
                        var p = [], q = [], g = f.valueAccessors, x = f.bindingParams,
            ...
            (function () {
                ...
                a.fa = function (b, c, d, e, f) {
                    ...
                    var l = this, g = b === J, h = g ? n : b, p = "function" == typeof h && !a.O(h), q,
                ...
                a.i = {
                    H: "childrenComplete", pa: "descendantsComplete", subscribe: function (b, c, d, e, f) {
                        var k = a.a.g.Ub(b, z, {});
                        k.Fa || (k.Fa = new a.T);
            ...
            (function () {
                ...
                a.j.Fc = {
                    getConfig: function (b, c) {
                        ...
                        b = g(b);
                        if ("string" === typeof c) f(a.a.ua(c)); else if (c instanceof Array) f(c); else if (e(c)) f(a.a.la(c.childNodes)); else if (c.element) if (c = c.element, A.HTMLElement ? c instanceof HTMLElement : c && c.tagName && 1 === c.nodeType) f(d(c)); else if ("string" === typeof c) {
            ...
            (function () {
                a.c.checked = {
                    after: ["value", "attr"], init: function (b, c, d) {
                        ...
                        if (h || m) {
                            var k = c(), l = h && a.a.f(k) instanceof Array, p = !(l && k.push && k.splice), q = m || l,
                                t = l ? g() : n;
            ...
            a.c.options = {
                init: function (b) {
                    ...
                    var h = b.multiple, m = 0 != b.length && h ? b.scrollTop : null, k = a.a.f(c()),
                        l = d.get("valueAllowUnset") && d.has("value"), p = d.get("optionsIncludeDestroyed");
                    c = {};
                    var q, t = [];
            ...
            (function () {
                ...
                a.C.F.prototype.nodes = function () {
                    ...
                    if (0 == arguments.length) {
                        ...
                        if (!f || e.jd) {
                            var g = this.text();
                            g && g !== e.bb && (f = a.a.Md(g, b.ownerDocument), a.a.g.set(b, c, {lb: f, bb: g, jd: !0}))
                        }
                        return f
                    }
                    e = arguments[0];
                ...
                a.Qd = function (b, d, g, h, m) {
                    ...
                    function u(a, c) {
                        v = m.createChildContext(a, {
                            as: z, noChildContext: g.noChildContext, extend: function (a) {
                                a.$index = c;
                                z && (a[z + "Index"] = c)
                            }
                        });
                ...
                a.c.template = {
                    init: function (b, c) {
                        ...
                        if ("string" == typeof d || "name" in d) a.h.Ea(b); else if ("nodes" in d) {
                            ...
                            a.a.Yb(d), (new a.C.ia(b)).nodes(e); else throw Error("Anonymous template defined, but no template content was provided");
                        return {controlsDescendantBindings: !0}
                    }, update: function (b, c, d, e, f) {
                        var g = c();
                        c = a.a.f(g);
            ...
            a.a.Pb = function () {
                function b(b, d, e, f, g) {
                    var h = Math.min, m = Math.max, k = [], l, p = b.length, q, n = d.length, r = n - p || 1,
                        v = p + n + 1, u, w, z;
                    ...
                    for (q = n; l || q;) n = k[l][q] - 1, q && n === k[l][q - 1] ? m.push(h[h.length] = {
                        ...
                        value: d[--q],
                        index: q
                    }) : l && n === k[l - 1][q] ? r.push(h[h.length] = {status: f, value: b[--l], index: l}) :
            ...
            (function () {
                ...
                a.a.ec = function (e, f, g, h, m, k) {
                    ...
                    h = h || {};
                    var t = a.a.g.get(e, c), r = !t, v = [], u = 0, w = 0, z = [], A = [], C = [], D = [], F = [], y,
                        I = 0;
                    if (r) a.a.D(f, l); else {
